...
const RecentTransactions: React.FC = () => {
  ...
  // Get and normalize recent transactions
    ...
    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
      ...
      <div className="divide-y divide-gray-200">
        {normalizedTransactions.map((transaction) => (
          <div key={transaction.transactionId} className="p-4 hover:bg-gray-50">
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                ...
                <span
                  className={`px-2 py-0.5 text-xs rounded-full capitalize ${getStatusClass(
                    transaction.status
                  )}`}
                >
                  {transaction.status}
